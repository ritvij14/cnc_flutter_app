                    ...
                    builder: (context, projectSnap) {
                      return Column(
                        children: [
                          ExpansionTile(
                            leading: Icon(
                              Icons.directions_run, color: Theme.of(context).buttonColor,
                              size: 40,
                            ),
                    ...
                    builder: (context, projectSnap) {
                      return Column(
                        children: [
                          ExpansionTile(
                            leading: Icon(
                              MdiIcons.scale, color: Theme.of(context).buttonColor,
                              size: 40,
                            ),
                    ...
                    builder: (context, projectSnap) {
                      return Column(
                        children: [
                          ExpansionTile(
                            leading: Icon(
                              Icons.thermostat_outlined, color: Theme.of(context).buttonColor,
                              size: 40,
                            ),
