...
class ChooseDairyGoals extends StatelessWidget {
  @override
...
class ChooseDairyGoalsPage extends StatefulWidget {
  ...
  @override
  _ChooseDairyGoalsPageState createState() => _ChooseDairyGoalsPageState();
}

class _ChooseDairyGoalsPageState extends State<ChooseDairyGoalsPage> {
  List<String> goals = [];
