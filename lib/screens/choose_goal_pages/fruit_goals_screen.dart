...
class ChooseFruitGoals extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ChooseFruitGoalsPage(title: 'Choose Fruit Goals'),
    );
  }
}

class ChooseFruitGoalsPage extends StatefulWidget {
  ChooseFruitGoalsPage({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  _ChooseFruitGoalsPageState createState() => _ChooseFruitGoalsPageState();
}

class _ChooseFruitGoalsPageState extends State<ChooseFruitGoalsPage> {
  List<String> goals = [];
