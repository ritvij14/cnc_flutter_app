...
class ChooseBeverageGoals extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ChooseBeverageGoalsPage(title: 'Choose Beverage Goals'),
    );
  }
}
...
class ChooseBeverageGoalsPage extends StatefulWidget {
  ...
  @override
  _ChooseBeverageGoalsPageState createState() =>
      _ChooseBeverageGoalsPageState();
}

class _ChooseBeverageGoalsPageState extends State<ChooseBeverageGoalsPage> {
  List<String> goals = [];
