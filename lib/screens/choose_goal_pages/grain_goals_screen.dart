...
class ChooseGrainGoals extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ChooseGrainGoalsPage(title: 'Choose Grain Goals'),
    );
  }
}

class ChooseGrainGoalsPage extends StatefulWidget {
  ChooseGrainGoalsPage({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  _ChooseGrainGoalsPageState createState() => _ChooseGrainGoalsPageState();
}

class _ChooseGrainGoalsPageState extends State<ChooseGrainGoalsPage> {
  List<String> goals = [];
