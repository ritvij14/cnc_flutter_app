...
class ChooseVegetableGoals extends StatelessWidget {
  @override
...
class ChooseVegetableGoalsPage extends StatefulWidget {
  ChooseVegetableGoalsPage({Key? key, required this.title}) : super(key: key);
...
class _ChooseVegetableGoalsPageState extends State<ChooseVegetableGoalsPage> {
  ...
  Widget _buildVegetableGoalView() {
